...
class PropertyImageBase(BaseModel):
    # Changed: Make image_url optional for input, as it is generated by backend
...
class PropertyBase(BaseModel):
    ...
    price_per_night: float = Field(default=1.0, gt=0)  # In cents
    currency: str = Field(default="USD", min_length=3, max_length=3)
    cleaning_fee: float = Field(default=0, ge=0)
    service_fee: float = Field(default=0.0, ge=0)
    weekly_discount: float = Field(default=0.0, ge=0, le=100)  # Percentage
    monthly_discount: float = Field(default=0.0, ge=0, le=100)  # Percentage
