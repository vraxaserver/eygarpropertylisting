...
from sqlalchemy import Column, String, Integer, Float, Boolean, DateTime, Enum, Text, ForeignKey, Index, CheckConstraint, UniqueConstraint, ARRAY, Table
...
# Many-to-Many Association Table for Property and Category
...
class Category(Base):
    ...
    icon = Column(String(500), nullable=True)  # URL or icon name
    ...
    # Relationships
    properties = relationship("Property", secondary=property_categories, back_populates="categories")
...
class Property(Base):
    ...
    place_type = Column(Enum(PlaceType), nullable=False, index=True)  # entire_place, private_room, etc.
    ...
    categories = relationship("Category", secondary=property_categories, back_populates="properties")
